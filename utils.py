...
def compute_metrics(intent_preds,intent_labels,slot_preds,slot_labels):
    ...
    slot_result = get_slot_metrics(slot_pres,slot_labels)
    sementric_result = get_sentence_frame_acc(intent_preds,intent_labels,slot_preds,slot_labels)

    results.update(intent_result)
    results.update(slot_result)
    results.update(sementric_result)
...
def read_prediction_text(args):
    return [text.strip() for text in open()]