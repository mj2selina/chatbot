...
if __name__ == '__main__':
    ...
    parser.add_argument("--logging_steps",default=200,type=int,help="Log every X updates steps.")
    parser.add_argument("--save_steps",default=200,type=int,help="Save checkpoint every X updates steps.")
    ...
    parser.add_argument("--slot_loss_coef",default=1.0,type=float,help="Coefficient for the slot loss.")
    #CRF option
