...
class JointProcessor(object):
    ...
    def _read_file(cls,input_file,quotechar=None):
        '''Read a blank separated value file.'''
    ...
    def _create_examples(self,texts,intents,slots,set_type):
        '''Create examples for teh training and dev sets.'''
        examples = []
...
def load_and_cache_examples(args,tokenizer,mode):
    ...
    if os.path.exists(cached_features_file):
        ...
        # Load data freatures from dataset file
    ...
    dataset = TensorDataset(all_input_ids,all_attention_mask,all_token_type_ids,all_intent_label_ids,all_slot_labels_ids)
    return dataset